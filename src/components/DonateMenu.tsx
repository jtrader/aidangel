...
export default function DonateMenu({ variant = "header", ngos }: DonateMenuProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        className="w-[calc(100vw-2rem)] max-w-md sm:max-w-lg max-h-[88vh] flex flex-col overflow-hidden rounded-2xl bg-card border border-border shadow-xl ring-1 ring-border/50 p-5 sm:p-6 motion-reduce:animate-none [&>button.absolute]:hidden"
        lang={language}
      >
